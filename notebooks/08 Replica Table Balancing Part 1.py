...
# MAGIC %md
# MAGIC ## 08 Replica Table Balancing Part 1
# MAGIC
# MAGIC **Pipeline:** GW CDA Claims (Practice) | **Step:** Raw to Replica (Balance Recon)
# MAGIC
# MAGIC **Purpose:** Prepares deduplicated source views for `cc_claim` and `cc_transaction`
# MAGIC to be consumed by the balance reconciliation notebook (Part 2).
# MAGIC
...
# MAGIC
# MAGIC Runs **in parallel** with `09 Replica Balance Recon - Source Prep Part 2` and with
...
# MAGIC | Lookup tables (Pattern B) | `cctl_transaction` | None - all 5 tables are primary tables |
...
# DBTITLE 1,cc_claim - Build Source View
build_source_view("cc_claim", df_cda_file_loads, df_raw_table_load)

# COMMAND ----------

# DBTITLE 1,cc_transaction - Build Source View
build_source_view("cc_transaction", df_cda_file_loads, df_raw_table_load)
