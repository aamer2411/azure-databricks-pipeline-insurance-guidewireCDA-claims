...
## ADF - Replica Data Validation (`pl_gc_replica_data_validation`)
...
![ADF Replica Data Validation Pipeline - pl_gc_replica_data_validation](pl_gc_replica_data_validation.png)
...
Azure SQL Query Editor or Object Explorer view showing the `abc` schema tables: cycle, step, job control and run tables, manifest tables, and lookup staging tables that power the ABC metadata framework.

![Azure SQL ABC Metadata Database](azure_sql.png)
